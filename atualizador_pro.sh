...
# Throughput Bull: Baileys + WhatsMeow (atualização completa / opção 2 via pro)
...
UPDATEAPP
  ...
  if ! atualizar_api_oficial_fast; then
    trata_erro "atualizar_api_oficial_pro"
  fi
